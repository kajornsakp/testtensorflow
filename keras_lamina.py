...
train_generator = train_datagen.flow_from_directory('lamina/train',
                                                    target_size=(300, 400),
...
validation_generator = test_datagen.flow_from_directory('lamina/test',
                                                        target_size=(300, 400),
                                                        class_mode='categorical')



model_name = "keras_lamina_1.h5"
model.fit_generator(
    train_generator,
